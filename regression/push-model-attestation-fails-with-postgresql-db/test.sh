...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   runtest.sh of /CoreOS/keylime/Regression/push-model-attestation-fails-with-postgresql-db
#   Description: Push-model attestation with PostgreSQL must succeed
#                (evidence_items.agent_id must hold a full agent UUID)
#
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
...
rlJournalStart
    ...
    rlPhaseStartTest "Push attestation with PostgreSQL must succeed"
        ...
        # No column size error in PostgreSQL log (RHEL-189524)
