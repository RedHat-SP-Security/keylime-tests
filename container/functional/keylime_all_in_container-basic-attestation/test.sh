...
rlJournalStart
    ...
    rlPhaseStartSetup "Do the keylime setup"
        ...
        rlRun "podman run --rm --attach stdout -v $PWD:/root:z tenant_image /bin/bash -c 'cd /root && keylime-policy create runtime -a allowlist.txt -e excludelist.txt 2> /dev/null' > policy.json"
