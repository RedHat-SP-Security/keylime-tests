...
rlJournalStart
    ...
    rlPhaseStartSetup "Do the keylime setup"
        ...
        rlRun "limeUpdateConf verifier max_retries 50"
        rlRun "limeUpdateConf verifier request_timeout 20"
    ...
    rlPhaseStartTest "Try to star just agent and check behavior when other services are down"
    ...
    rlPhaseStartTest "Start verifier, establish attestation and then make verifier unreachable again"
        ...
        for i in {1..2}; do
            ...
            rlRun "limeStopVerifier"
            rlRun "limeWaitForAgentStatus $AGENT_ID 'Registered'"
            rlRun "keylime_tenant -c cvlist" 1
            rlRun "limeStartVerifier"
            rlRun "limeWaitForVerifier" 
            rlRun "limeWaitForAgentStatus $AGENT_ID 'Get Quote'"
            rlRun -s "keylime_tenant -c cvlist"
