...
rlJournalStart
    ...
    rlPhaseStartTest "Try adding agent with PRC15 configured in tpm_policy"
        ...
        rlRun -s "keylime_tenant -u $AGENT_ID --verify --tpm_policy '${TPM_POLICY}' --allowlist policy.json -f /etc/hostname -c add --mb_refstate mb_refstate.txt" 1
    ...
    rlPhaseStartTest "Add agent with empty tpm_policy"
        rlRun -s "keylime_tenant -u $AGENT_ID --verify --tpm_policy '{}' --allowlist policy.json -f /etc/hostname -c add --mb_refstate mb_refstate.txt"
    ...
    rlPhaseStartTest "Add agent with tpm_policy generated by scripts/create_mb_refstate and incorrect PCR banks"
        ...
        rlRun -s "keylime_tenant -u $AGENT_ID --verify --tpm_policy '{}' --allowlist policy.json -f /etc/hostname -c add --mb_refstate mb_refstate2.txt"
