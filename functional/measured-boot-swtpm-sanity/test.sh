...
rlJournalStart
    ...
    rlPhaseStartTest "Add agent with tpm_policy generated by scripts/create_mb_refstate and incorrect PCR banks"
        # use create_mb_refstate from keylime_sources or download it from upstream master branch
        if [ -f /var/tmp/keylime_sources/scripts/create_mb_refstate ]; then
            rlRun "cp /var/tmp/keylime_sources/scripts/create_mb_refstate . && chmod a+x create_mb_refstate"
        else
    ...
    rlPhaseStartTest "Add agent with tpm_policy generated by scripts/create_mb_refstate and correct PCR banks"
