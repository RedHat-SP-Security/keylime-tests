...
class Example(policies.Policy):
    ...
    def refstate_to_test(self, refstate: policies.RefState) -> tests.Test:
        ...
        strid="8be4df61-93ca-11d2-aa0d-00e098032b8c"
        sigtype1="a5c059a1-94e4-4aa7-87b5-ab155c2bf072"
        sigtype2="c1c41626-504c-4092-aca9-41f936934328"
        vd_driver_config.set(
            strid, "SecureBoot", tests.FieldTest("Enabled", tests.StringEqual("Yes"))
        )
        vd_driver_config.set(
            strid,
            "PK",
            tests.KeySubset(sigtype1, sigs_strip0x(refstate["pk"])),
        )
        vd_driver_config.set(
            strid,
            "KEK",
            tests.KeySubset(sigtype1, sigs_strip0x(refstate["kek"])),
        )
        vd_driver_config.set(
            "d719b2cb-3d3a-4596-a3bc-dad00e67656f",
            "db",
            tests.KeySubset(sigtype1, sigs_strip0x(refstate["db"])),
        )
        vd_driver_config.set(
            "d719b2cb-3d3a-4596-a3bc-dad00e67656f",
            "dbx",
            tests.KeySuperset(sigtype2, sigs_strip0x(refstate["dbx"])),
        )
        ...
        vd_authority.set("d719b2cb-3d3a-4596-a3bc-dad00e67656f", "db", tests.OnceTest(tests.AcceptAll()))
        # Accept all SbatLevels of the Shim, because we already checked the hash of the Shim itself.
        vd_authority.set("605dab50-e046-4300-abb6-3dd810dd8b23", "SbatLevel", tests.OnceTest(tests.AcceptAll()))
        ...
        vd_authority.set("605dab50-e046-4300-abb6-3dd810dd8b23", "Shim", tests.OnceTest(tests.AcceptAll()))
